...
{
    public static class Prophet21SerializationService
    {
        public static string Serialize<T>(T request)
        {
            ...
            {
                throw new Exception($"Error serializing {typeof(T).FullName} to XML request. Message: {exception.Message}.");
            }
        }
        ...
        public static T Deserialize<T>(string response)
        {
            ...
            {
                throw new Exception($"Error deserializing XML response to {typeof(T).FullName}. XML Response: {response}. Message: {exception.Message}.");
            }
        }
